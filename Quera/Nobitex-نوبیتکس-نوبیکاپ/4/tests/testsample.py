...
class TestFoo(TestCase):
    def setUp(self):
        ...
        self.user1 = CustomUser.objects.create(username='isara', full_name='Sara Ahmadi', gender='F',
                                               national_code='5110126432', birthday_date=date,
